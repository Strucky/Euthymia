...
public class Config {
	...
	public static final boolean NEW_COMBAT = false;
	/**
	 ...
	 * Your server name.
	 */
	public static final String SERVER_NAME = "Dmints&archery";
	 ...
	 */
	public static final String FORUMS = "www.rs-ts.com";
	 ...
	 */
	public static final int START_LOCATION_X = 2344;
	public static final int START_LOCATION_Y = 3802;

	/**
	 * The re-spawn point of when someone dies.
	 */
	public static final int RESPAWN_X = 2344;
	public static final int RESPAWN_Y = 3802;

	/**
	 * The re-spawn point of when a duel ends.
	 */
	public static final int DUELING_RESPAWN_X = 2344;
	public static final int DUELING_RESPAWN_Y = 3802;

	/**
	 * Fight Caves Respawn
	 */
	public static final int FIGHT_CAVE_RESPAWN_X = 2344;
	public static final int FIGHT_CAVE_RESPAWN_Y = 3802;
	 ...
	 */
	public static final int EXP_GAINER = 100;
	public static final int MELEE_EXP_RATE = 80; // damage * exp rate
	public static final int RANGE_EXP_RATE = 80;
	public static final int MAGIC_EXP_RATE = 80;
	 ...
	 */
	public static final int INCREASE_SPECIAL_AMOUNT = 14000;
	 ...
	 */
	public static final int NPC_FOLLOW_DISTANCE = 15; // 15 squares
	...
	public static final int[][] commonDrops = { 
			{ 5291, 1 + Misc.random(5) },// common
	...
	public static final int[][] NPC_DROPS = {
		// Barrow Boiiiiss
			...
			{ 2025, 4712, 1, 35 },
			{ 2025, 4714, 1, 35 },*/
		{ 1472, 995, 500 + Misc.random(1000), 15 }, // rune ess
		{ 1472, 526, 1, 0 }, // jung demons
		{ 1472, 1319, 1, 10 }, // jung demons
		{ 1472, 1163, 1, 10 }, // jung demons
		{ 1472, 1113, 1, 13 }, // jung demons
		{ 1472, 1185, 1, 13 }, // jung demons
		{ 1472, 3476, 1, 17 }, // jung demons
		{ 1472, 11732, 1, 180 }, // jung demons
			// Alkharid Warriors
			{ 18, 526, 1, 0 }, // bones
			...
			{ 1113, 1079, 1, 45 }, // rune platelegs
			{ 1615, 1147, 1, 35 }, // rune med
			{ 1615, 1149, 1, 50 }, // dmed
			{ 1615, 4151, 1, 135 }, // whip
			...
			//kh scorp
			{ 271, 1727, 1, 5}, // guam seed 
			{ 271, 1127, 1, 30}, // guam seed 
			//spirit tree
			{ 443, 1359, 1, 10 }, // guam seed 
			{ 443, 561, 5+Misc.random(5), 3 }, // guam seed 
			//Unicorn
			{ 89, 526, 1, 0 }, // guam seed 
			{ 89, 237, 1, 1 }, // Unicorn horn
			{ 89, 2890, 1, 10 }, // Elemental shield
			//kalrag
			{ 997, 526, 1, 0 }, // Bones - Always
			{ 997, 11377, 1, 9 }, // Rune hasta
			{ 997, 1712, 1, 20 }, // amulet of glory (4)
			{ 997, 1331, 1, 10 }, // adamant scimi 
			{ 997, 1319, 1, 20 }, // rune 2h sword
			// Demons
			// Lesser Demon
			// { 82, 2713, 1, 85 },
			{ 82, 4587, 1, 40 }, // guam seed 
			...
			{ 271, 11373, 1, 6 }, // Bones - Always
			{ 507, 526, 1, 0 }, // Bones - Always
			{ 507, 11375, 1, 4 }, // Bones - Always
			{ 75, 526, 1, 0 }, // Bones - Always
			{ 76, 526, 1, 0 }, // Bones - Always
			{ 86, 526, 1, 0 }, // Bones - Always
			{ 75, 562, Misc.random(10)+ Misc.random(10), 0 }, // Bones - Always
			{ 76, 562, Misc.random(10)+ Misc.random(10), 0 }, // Bones - Always
			{ 86, 562,  Misc.random(10)+ Misc.random(10), 0 }, // Bones - Always
			{ 507, 995, Misc.random(6000)+100, 0 }, // Bones - Always
			{ 271, 526, 1, 0 }, // Bones - Always
			{ 997, 526, 1, 0 }, // Bones - Always
			{ 997, 11377, 1, 9 }, // Bones - Always
			{ 142, 11371, 1, 5 }, // Bones - Always
			{ 141, 11371, 1, 5 }, // Bones - Always
			{ 142, 526, 1, 0 }, // Bones - Always
			{ 141, 526, 1, 0 }, // Bones - Always
			{ 444, 526, 1, 0 }, // Bones - Always
			{ 444, 11371, 1, 5 }, // Bones - Always
			{ 445, 11371, 1, 5 }, // Bones - Always
			{ 445, 526, 1, 0 }, // Bones - Always
			{ 444, 995, 1 + Misc.random(25), 15 },
			{ 445, 995, 1 + Misc.random(25), 15 },
			{ 1770, 526, 1, 0 }, // Bones - Always
			{ 1770, 995, 1 + Misc.random(25), 15 },
			{ 1770, 1438, 1, 20 },
			{ 1770, 1009, 1, 30 },
			{ 1770, 1917, 1, 15 },
			{ 1770, 1919, 1, 35 },
			{ 1771, 526, 1, 0 }, // Bones - Always
			{ 1771, 995, 1 + Misc.random(25), 15 },
			{ 1771, 1438, 1, 20 },
			{ 1771, 1009, 1, 30 },
			{ 1771, 1917, 1, 15 },
			{ 1771, 1919, 1, 35 },
			{ 1772, 526, 1, 0 }, // Bones - Always
			{ 1772, 995, 1 + Misc.random(25), 15 },
			{ 1772, 1438, 1, 20 },
			{ 1772, 1009, 1, 30 },
			{ 1772, 1917, 1, 15 },
			{ 1772, 1919, 1, 35 },
			{ 1773, 526, 1, 0 }, // Bones - Always
			{ 1773, 995, 1 + Misc.random(25), 15 },
			{ 1773, 1438, 1, 20 },
			{ 1773, 1009, 1, 30 },
			{ 1773, 1917, 1, 15 },
			{ 1773, 1919, 1, 35 },
			{ 1774, 526, 1, 0 }, // Bones - Always
			{ 1774, 995, 1 + Misc.random(25), 15 },
			{ 1774, 1438, 1, 20 },
			{ 1774, 1009, 1, 30 },
			{ 1774, 1917, 1, 15 },
			{ 1774, 1919, 1, 35 },
			{ 1775, 526, 1, 0 }, // Bones - Always
			{ 1775, 995, 1 + Misc.random(25), 15 },
			{ 1775, 1438, 1, 20 },
			{ 1775, 1009, 1, 30 },
			{ 1775, 1917, 1, 15 },
			{ 1775, 1919, 1, 35 },
			{ 1776, 526, 1, 0 }, // Bones - Always
			{ 1776, 995, 1 + Misc.random(25), 15 },
			{ 1776, 1438, 1, 20 },
			{ 1776, 1009, 1, 30 },
			{ 1776, 1917, 1, 15 },
			{ 1776, 1919, 1, 35 },
			...
			// Barbarian
			{ 3246, 526, 1, 0 },
			{ 3246, 995, 18 + Misc.random(13), 0 },
			{ 3253, 526, 1, 0 },
			{ 3253, 995, 18 + Misc.random(13), 0 },
			{ 3254, 526, 1, 0 },
			{ 3254, 995, 18 + Misc.random(13), 0 },
			{ 3256, 526, 1, 0 },
			{ 3256, 995, 18 + Misc.random(13), 0 },
			
			//Mugger
			{ 175, 526, 1, 0 },
			{ 175, 998, 1 + Misc.random(12), 0 },
			...
			//chicken
			{ 41, 2138, 1, 0 }, // raw chicken
			{ 41, 526, 1, 0 }, // bones
			{ 41, 314, 15, 5 }, // feather x15

			//Cow
			{ 81, 2132, 1, 0 }, // raw beef
			{ 81, 526, 1, 0 }, // bones
			{ 81, 1739, 1, 0 }, // cowhide
			
			//Cow calf
			{ 1766, 2132, 1, 0 }, // raw beef
			{ 1766, 526, 1, 0 }, // bones
			
			//Farmer
			{ 7, 995, 20, 1 },	//Coins common
			{ 7, 1965, 1, 4 },	//Cabbage Common
			{ 7, 313, 20, 0 },	//Fishing bait Common
			{ 7, 5341, 1, 3 },	//Rake common
			{ 7, 882, 25, 3 },	//Bronze Arrows common
			{ 7, 5298, 3, 10 },	//avantoe rare
			{ 7, 5299, 3, 10 },	//kwarm rare 
			{ 7, 5295, 3, 10 },	//rannar rare
			{ 7, 5303, 3, 10 },	//dward weed rare
			{ 7, 5343, 1, 3 },	//seed dibber
			{ 7, 526, 1, 0 },	//bones
			
			//Druid
			{ 14, 1437, 5, 4 },	//rune essensse
			{ 14, 995, 5, 1 },	//Coins
			{ 14, 1381, 1, 8 },	//staff of air
			{ 14, 526, 1, 0 },	//bones
			
			//Man (2)
			{ 2, 995, 15, 1 },	//Coins common
			{ 2, 526, 1, 0 },	//bones
			
			//Woman ()
			{ 5, 995, 15, 1 },	//Coins common
			{ 5, 1437, 3, 4 },	//rune essensse
			{ 5, 5291, 1 + Misc.random(2), 17 }, // guam seed
			{ 5, 5292, 1 + Misc.random(2), 25 }, // marrentil seed
			{ 5, 5293, 1 + Misc.random(2), 26 }, // tarromin seed
			{ 5, 5294, 1 + Misc.random(2), 27 }, // harralander seed
			{ 5, 5295, 1 + Misc.random(2), 39 }, // ranarr seed
			{ 5, 5296, 1 + Misc.random(2), 24 }, // toadflax seed
			{ 5, 5297, 1 + Misc.random(2), 26 }, // irit seed
			{ 5, 5298, 1 + Misc.random(2), 27 }, // avantoe seed
			{ 5, 5299, 1 + Misc.random(2), 34 }, // kwuarm seed
			{ 5, 5300, 1 + Misc.random(2), 39 }, // snapdragon seed
			{ 5, 5301, 1 + Misc.random(2), 30 }, // cadantine seed
			{ 5, 5302, 1 + Misc.random(2), 38 }, // lantadyme seed
			{ 5, 5303, 1 + Misc.random(2), 40 }, // dwarfweed seed
			{ 5, 5304, 1 + Misc.random(2), 67 }, // torstol seed
			{ 5, 526, 1, 0 },	//bones
	...
	public static final int RUNECRAFTING_EXPERIENCE = 1550;
