...
public class Cooking extends SkillHandler {
	...
	public static void cookThisFood(Client p, int i, int object) {
		switch(i) {
			case 2307:	cookFish(p, i, 100, 1, 2311, 2309, object); break; //Bread
			...
			case 2132:	cookFish(p, i, 100, 1, 2146, 2142, object); break;
			case 3226:	cookFish(p, i, 100, 1, 7222, 3228, object); break;
			case 2138:	cookFish(p, i, 100, 1, 2144, 2140, object); break;
			case 3142:	cookFish(p, i, 100, 1, 3148, 3144, object); break;
	...
	private static void cookTheFish(final Client c) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				} else if(c.playerEquipment[c.playerHands] == 775 && Misc.random(10) > 3){
					c.sendMessage("You successfully cook the "+ c.getItems().getItemName(c.playerSkillProp[7][0]).toLowerCase() +".");
					c.getPA().addSkillXP(c.playerSkillProp[7][1], 7);
					c.getItems().addItem(c.playerSkillProp[7][4], 1);
