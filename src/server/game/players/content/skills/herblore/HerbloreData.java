...
public class HerbloreData {
	...
	public enum PotionData {
		ATTACK_POTION(91, 221, 121, 1, 25, false), ANTIPOISON(93, 235, 175, 5, 38, false), STRENGTH_POTION(
				95, 225, 115, 12, 50, false), RESTORE_POTION(97, 223, 127, 22, 63, false), ENERGY_POTION(97, 1975, 3010, 22, 63, false), 
				DEFENCE_POTION(99, 239, 133, 30, 75, false), COMBAT_POTION(97, 9736, 9741, 36, 84, false), AGILITY_POTION(3002, 2152, 3034, 36, 84, false), 
				PRAYER_POTION(99, 231, 139, 38, 88, false), SUPER_ATTACK(101, 221, 145, 45, 100, false), SUPER_ANTIPOISON(
				101, 235, 181, 48, 106, false), FISHING_POTION(103, 231, 151, 50, 112, false), SUPER_ENERGY(103, 2970, 3018, 52, 125, false), 
				SUPER_STRENGTH(105, 225, 157, 55, 125, false),WEAPON_POISON1(105, 241, 5937, 60, 137, false), SUPER_RESTORE(
				3004, 223, 3026, 63, 142, false), ANTIDOTE_POISON1(3002, 6049, 5945, 63, 142, false), 
				SUPER_DEFENCE(107, 239, 163, 66, 150, false), ANTIFIRE_POTION(2483, 241, 2454, 69, 158, false), RANGING_POTION(109, 245, 169, 72, 163, false), 
				MAGIC_POTION(2483, 3138, 3042, 76, 173, false), ZAMORAK_BREW(111, 247, 189, 78, 175, false), 
				ANTIDOTE_POISON2(101, 6051, 5954, 81, 180, false),SARADOMIN_BREW(3002, 6693, 6687, 81, 180, false), 
				WEAPON_POISON2(3002, 6018, 5940, 81, 180, false), 
