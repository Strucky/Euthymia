...
public class SkillInterfaces {
	...
	public void attackComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerAttack][0], 0);
			optionTab("Attack", "Milestones", "Bronze", "Iron", "Steel",
	...
	public void strengthComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerStrength][0], 0);
			optionTab("Strength", "Milestones", "Weaponry", "Armor",
					"Milestones", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void defenceComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerDefence][0], 0);// Skill
																	// mastery
			optionTab("Defence", "Milestones", "Bronze", "Iron", "Steel",
					"Black", "White", "Mithril", "Adamant", "Rune", "Dragon",
					"Barrows", "Magic", "Equipment", "Milestones");
		}
	}
	...
	public void rangedComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerRanged][0], 1);
			optionTab("Ranged", "Milestones", "Bows", "Thrown", "Armour",
					"Crossbows", "Other", "Milestones", "", "", "", "", "", "",
					"");
		}
	}
	...
	public void prayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerPrayer][0], 1);
			optionTab("Prayer", "Milestones", "Prayers", "Equipment",
					"Milestones", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void magicComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("75", "Trident of the seas", 11994, 26);
			menuLine("75", "Staff of the Dead(With 75 Attack)", 15110, 27);
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerMagic][0], 1);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerRunecrafting][0], 0);
	...
	public void hitpointsComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerHitpoints][0], 0);
	...
	public void agilityComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerAgility][0], 1);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			clearMenu();
			menuLine("3", "Attack Potion (Guam + Eye of Newt)", 121, 0);
			menuLine("5", "Anti-Poison(Marrentil + Unicorn Horn Dust)", 175, 1);
			...
			menuLine("30", "Defence Potion (Marrentil + Unicorn Horn Dust)", 133, 5);
			menuLine("34", "Agility Potion (Toadflax + Toad's Legs)", 3034, 6);
			menuLine("38", "Prayer restore Potion (Ranarr + Snape Grass)", 139, 7);
			menuLine("45", "Super Attack Potion (Irit + Eye of Newt)", 145, 8);
			menuLine("48", "Super Anti-Poison (Irit + Unicorn Horn Dust)", 181, 9);
			menuLine("50", "Fishing Potion (Avantoe + Snape Grass)", 151, 10);
			menuLine("52", "Super Energy Potion (Avantoe + Mort Myre Fungus)", 3018, 11);
			menuLine("55", "Super Strength Potion (Kwarm + Limpwurt Root)", 157, 12);
			menuLine("60", "Weapon Poison (Kwarm + Dragon Scale Dust)", 187, 13);
			menuLine("63", "Super Restore Potion (Snapdragon + Red Spider Eggs)", 3026, 14);
			menuLine("66", "Super Defence Potion (Cadantine + White Berries)", 163, 15);
			menuLine("68", "Antidote+ (Toadflax + Yew Roots)", 5945, 16);
			menuLine("69", "Ranging Potion (Dwarf Weed + Wine of Zamorak)", 169, 17);
			menuLine("72", "Antifire Potion (Lantadyme + Potato Cactus)", 2454, 18);
			menuLine("73", "Weapon Poison+ (Cactus Spine + Red Spider Eggs)", 5937, 19);
			menuLine("76", "Magic Potion (Lantadyme + Potato Cactus)", 3042, 20);
			menuLine("78", "Zamorak Brew (Torsol + Jangerberries)", 189, 21);
			menuLine("79", "Antidote++ (Irit + Magic Roots)", 5954, 22);
			menuLine("81", "Saradomin Brew (Toadflax + Bird Nest)", 6687, 23);
			menuLine("82", "Weapon Poison++ (Toadflax + Poison Ivy Berries)", 5940, 24);
			...
			menuLine("99", "Eduardo's Bones (99 in all skills)", 528, 14);
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerHerblore][0], 0);
			optionTab("Herblore", "Milestones", "Potions", "Herbs",
					"Milestones", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void thievingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill mastery",
					c.getItems().skillcapes[c.playerThieving][0], 0);
			optionTab("Thieving", "Milestones", "Pickpocket", "Stalls",
					"Chests", "Milestones", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void craftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerCrafting][0], 1);
			optionTab("Crafting", "Milestones", "Weaving", "Armour",
	...
	public void fletchingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerFletching][0], 0);
	...
	public void slayerComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Slayer", "Equipment", "Equipment", "Monsters",
					"Masters", "Milestones", "", "", "", "", "", "", "", "", "");
		}
			...
			optionTab("Slayer", "Monsters", "Equipment", "Monsters", "Masters",
					"Milestones", "", "", "", "", "", "", "", "", "");
		}
			...
			optionTab("Slayer", "Masters", "Equipment", "Monsters", "Masters",
					"Milestones", "", "", "", "", "", "", "", "", "");
		}
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerSlayer][0], 0);
			optionTab("Slayer", "Milestones", "Equipment", "Monsters",
					"Masters", "Milestones", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("98", type + " Claws(After Death Plateu) - 2 Bars", 3101,
					18);
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerSmithing][0], 0);
			optionTab("Smithing", "Milestones", "Smelting", "Bronze", "Iron",
					"Steel", "Mithril", "Adamantite", "Runite", "Gold",
					"Elemental", "Other", "Milestones", "", "");
		}
	}
	...
	public void fishingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("5", "Seazyne - Sea Bait Fishing", 327, 1);
			...
			menuLine("85", "Raw dark crab - Fishing Guild", 11934, 25);
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerFishing][0], 1);
			optionTab("Fishing", "Milestones", "Techniques", "Catches",
					"Milestones", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void cookingComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Cooking", "Meats", "Meats", "Bread", "Pies", "Stews",
					...
					"Potatoes", "Diary", "Gnome", "Milestones");
		}
			...
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerCooking][0], 1);
			optionTab("Cooking", "Milestones", "Meats", "Bread", "Pies",
					"Stews", "Pizzas", "Cakes", "Wine", "Hot Drinks",
					"Brewing", "Potatoes", "Diary", "Gnome", "Milestones");
		}
	}
	...
	public void firemakingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerFiremaking][0], 0);
			optionTab("Firemaking", "Milestones", "Firemaking", "Equipment",
					"Milestones", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void woodcuttingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerWoodcutting][0], 0);
	...
	public void farmingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					c.getItems().skillcapes[c.playerFarming][0], 0);
			optionTab("Farming", "Milestones", "Allotments", "Hops", "Trees",
					"Fruit Trees", "Bushes", "Flowers", "Herbs", "Special",
					"Scarecrows", "Milestones", "", "", "");
		}
	}
