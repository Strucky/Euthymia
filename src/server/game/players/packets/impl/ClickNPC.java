...
public class ClickNPC implements PacketType {
	...
	public void processPacket(final Client c, int packetType, int packetSize) {
		...
		case ATTACK_NPC:
			...
			boolean usingCross =c.playerEquipment[c.playerWeapon] == 9181 &&  c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerWeapon] == 15041 && c.playerEquipment[c.playerWeapon] == 15003;
			...
			if (c.getCombat().correctBowAndArrows() < c.playerEquipment[c.playerArrows]
					...
					&& c.playerEquipment[c.playerWeapon] != 9185
							&& c.playerEquipment[c.playerWeapon] != 9181
