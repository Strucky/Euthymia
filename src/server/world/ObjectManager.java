...
public class ObjectManager {
	...
	public static void loadNeitiSpawns(Client player) {
		player.getPA().checkObjectSpawn(21273, 2359, 3799, 0, 10);//tree
		player.getPA().checkObjectSpawn(411, 2333, 3806, 3, 10);//altar
		player.getPA().checkObjectSpawn(3192, 2326, 3808, 2, 10); //  Home Score
		player.getPA().checkObjectSpawn(6552, 2333, 3798, 3, 10); // ancient/lunar
		player.getPA().checkObjectSpawn(4876, 2339, 3806, 3, 10); // neiti stall general|
		player.getPA().checkObjectSpawn(13615, 2344, 3796, 0, 10); // varrock portal
		player.getPA().checkObjectSpawn(13627, 2342, 3796, 0, 10); // yanille portal
		player.getPA().checkObjectSpawn(13616, 2340, 3796, 0, 10); // gwd portal
	}
	public static void loadCustomSpawns(Client c) {
		...
		;
		c.getPA().checkObjectSpawn(879, 3079, 3249, 0, 10);
